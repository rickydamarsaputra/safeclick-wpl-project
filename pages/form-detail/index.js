  ...
  return (
    <>
      ...
      <div className={`container ${styles.wrapper}`}>
        <h1 className={styles.heading}>Loan Detail</h1>
        {/* card with detail info start */}
        <div className={styles.card}>
          <div>
            <Image
              src="/assets/lamp-product.jpg"
              alt="Lamp Product"
              width={148}
              height={148}
            />
          ...
          <div>
            ...
            >
              <h2>Half Rounded Hanging Lamp</h2>
              <div
                style={{
                  display: "flex",
                  alignItems: "center",
        ...
        <form style={{ marginTop: "48px" }}>
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              id="shortAddress"
              rows="3"
              placeholder="e.g. Jalan Ikan Bawal No 1"
            />
          </div>
          <div className="mb-3">
            <label
            ...
            <textarea
              ...
              id="detailAddress"
              rows="3"
              placeholder="e.g. Samping Bank Mandiri"
            />
          </div>
          <div className="d-flex justify-content-end my-5">
            <button className="btn btn-primary-700 rounded-pill">
              Submit Form
            </button>
          </div>
        </form>
